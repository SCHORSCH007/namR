...
parser.add_argument("-d", "--description", type=str, help="Rename supported Pictures with an given Description to YYYY-MM-DD_HH-MM-SS_<Description> on other file_formats this will be given to the AI")
...
if not api_key:
    print("please first setup your gemini api key")
